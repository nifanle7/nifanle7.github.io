...
(function () {
  ...
  /* ============ 6. 公告条关闭 + localStorage 记忆 ============ */
  (function () {
    var ann = document.querySelector('.announcement');
    if (!ann) return;
    var aid = ann.getAttribute('data-announcement-id') || 'site-announcement';
    var key = 'sail:ann:' + aid;
    try { if (localStorage.getItem(key) === '1') ann.classList.add('is-dismissed'); } catch (e) {}
    var btn = ann.querySelector('.announcement__close');
